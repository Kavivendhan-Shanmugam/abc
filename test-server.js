// Quick test server for testing login functionality
...
// Simple login endpoint with PostgreSQL syntax
...
app.get('/', (req, res) => {
  res.json({ 
    message: 'Test PostgreSQL Backend API Server is running on Neon!', 
    status: 'OK',
    port: port
  });
});
